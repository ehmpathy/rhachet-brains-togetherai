 ...
 *
 * .sources:
 *   - rates: https://www.together.ai/rates
...
> = {
   ...
   * qwen3-coder-next
   * .sources:
   *   - rates: https://www.together.ai/rates ($0.50/1M input, $1.20/1M output)
   *   - context: 262K
   ...
   * qwen3-coder-480b
   * .sources:
   *   - rates: https://www.together.ai/rates ($2.00/1M input, $2.00/1M output)
   *   - context: 262K
   ...
   * qwen3-235b
   * .sources:
   *   - rates: https://www.together.ai/rates ($0.20/1M input, $0.60/1M output)
   *   - context: 131K
   ...
   * deepseek-v3.1
   * .sources:
   *   - rates: https://www.together.ai/rates ($1.25/1M input, $1.25/1M output)
   *   - context: 128K
   ...
   * deepseek-r1
   * .sources:
   *   - rates: https://www.together.ai/rates ($3.00/1M input, $7.00/1M output)
   *   - context: 128K
   ...
   * kimi-k2
   * .sources:
   *   - rates: https://www.together.ai/rates ($1.00/1M input, $3.00/1M output)
   *   - context: 128K
   ...
   * kimi-k2.5
   * .sources:
   *   - rates: https://www.together.ai/rates ($0.50/1M input, $2.80/1M output)
   *   - context: 128K
   ...
   * llama-4-maverick
   * .sources:
   *   - rates: https://www.together.ai/rates ($0.27/1M input, $0.85/1M output)
   *   - context: 1M
   ...
   * llama-3.3-70b
   * .sources:
   *   - rates: https://www.together.ai/rates ($0.88/1M input, $0.88/1M output)
   *   - context: 128K
   ...
   * glm-4.7
   * .sources:
   *   - rates: https://www.together.ai/rates ($0.45/1M input, $2.00/1M output)
   *   - context: 128K
